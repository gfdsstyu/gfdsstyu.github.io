 ...
 */
export function createMemoryTipPrompt(question, answer) {
  return `[역할]
당신은 회계감사 2차 시험을 준비하는 학생의 암기 코치입니다.
아래 문제와 정답을 보고, 학생이 쉽게 기억할 수 있도록 **유연한 암기 팁**을 제공하세요.

[암기 기법 옵션 - 자유롭게 선택]
1. **두문자 암기법**: 핵심 단어(모범답안 단어 자체(동의어 등으로)를 바꿔서는 안됩니다)의 첫 글자를 조합. 익살스러워서 기억에 남으면 좋음. 선정적이거나 자극적이어도 좋음. (예: "감사증거의 충분성과 적합성" → "충·적")
