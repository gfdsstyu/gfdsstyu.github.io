  ...
  problemList.innerHTML = records.map((rec, idx) => {
    ...
    return `
      <div class="border rounded-lg p-4 dark:border-gray-700" data-daily-problem="${idx}">
        ...
        <div class="daily-coaching-tip hidden mt-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded">
          <div class="flex justify-between items-start mb-2">
            <p class="text-sm font-bold text-blue-900 dark:text-blue-100">💡 암기 팁</p>
            <div class="flex gap-2">
              <button class="coaching-regen-btn text-xs px-2 py-1 rounded bg-orange-100 dark:bg-orange-900 text-orange-700 dark:text-orange-200 hover:bg-orange-200 dark:hover:bg-orange-800 transition" type="button" data-qid="${rec.qid}">
                🔄 새로 생성
              </button>
