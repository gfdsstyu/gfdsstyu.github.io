...
3. **추가 학습 제안 (반드시 포함):**
   - **중요:** 사용자가 작성하지 않은 모범 답안의 절차를 명시적으로 나열하세요.
   - 사용자가 3개 이상을 잘 작성했더라도, 모범 답안의 **나머지 절차들**을 학습용으로 알려주는 것은 매우 중요합니다.
   - 예시 형식: "모범 답안에는 다음과 같은 추가 절차도 있습니다 (참고용, 감점 요인 아님):"
     * "민감도 분석 수행 - 할인율 등 주요 가정이 변동될 때 영향을 평가"
     * "외부 전문가 활용 - 복잡한 평가 모형의 적정성 검토"
   - 각 추가 절차에 대해 **왜 이 절차가 유용한지** 1-2문장으로 설명하세요.
   - **이것은 감점이 아닙니다.** 사용자가 작성한 3개가 우수하면 90점 이상을 주되, 추가 절차도 알려줘서 학습 효과를 높이는 것입니다.
...
## JSON 응답 형식
{
  ...
  "additionalSuggestions": [
    "【사용자가 작성하지 않은 모범답안 절차 1】 민감도 분석 수행 - 할인율 등 주요 가정 변동 시 영향 평가. 추정의 불확실성을 검증하는 핵심 절차입니다.",
    "【사용자가 작성하지 않은 모범답안 절차 2】 외부 전문가 활용 - 복잡한 평가 모형의 적정성과 객관성을 확보하는 절차입니다."
  ],
