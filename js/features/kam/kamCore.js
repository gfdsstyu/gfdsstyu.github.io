...
1. **오직 [제공된 모범 답안]에 명시적으로 포함된 내용이 누락되었을 때만 지적하세요.**
...
- ✅ "모범 답안에 있는 '외부 시장자료와 대조' 절차가 누락되었습니다."
- ✅ "모범 답안의 '[구체적 절차 원문 인용]'이 사용자 답안에 빠져 있습니다."
...
**작성 지침:**
- 모범 답안에는 있지만 사용자가 누락한 **결정적인 절차(Critical Missing Procedures)**를 지적하세요.
...
**🚨 중요 제약:**
1. **모범 답안의 핵심 절차를 누락했다면**, 학습을 위해 반드시 지적해야 합니다.
2. **단, 모범 답안에 없는 절차를 사용자가 하지 않았다고 해서 감점하거나 지적하지 마세요.**
   - 예: 모범 답안에 "민감도 분석"이 없다면, 사용자가 민감도 분석을 하지 않았어도 Gap Analysis에 포함하지 마세요.
   - 예: 모범 답안에 "전문가 활용"이 없다면, 사용자가 전문가를 언급하지 않았어도 감점하지 마세요.
3. **점수는 "모범 답안과의 일치도" + "작성한 내용의 질적 수준"을 기준으로 산정합니다. 모범 답안에 없는 내용을 하지 않았다고 감점하지 마세요.**
...
**작성 지침:**
- 모범 답안에는 있지만 사용자가 누락한 **결정적인 절차**를 반드시 명시하세요.
